 ...
 */
public class ResponsePublisher<T> extends HttpEntity<Publisher<T>> {
	 ...
	 */
	private ResponsePublisher(Publisher<T> body, MultiValueMap<String, String> headers, Object statusCode) {
		super(body, headers);
	...
	public boolean equals(Object other) {
		...
		ResponsePublisher<?> otherEntity = (ResponsePublisher<?>) other;
	...
	/**
	 * A shortcut for creating a {@code ResponsePublisher} with the given body and
	 * the status set to {@linkplain HttpStatus#OK OK}.
	 * @return the created {@code ResponsePublisher}
	 * @since 4.1
	 */
	public static <T> ResponsePublisher<T> ok(Publisher<T> body) {
	...
	public interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
		 ...
		 */
		<T> ResponsePublisher<T> body(Publisher<T> body);
	}
	...
	private static class DefaultBuilder implements BodyBuilder {
		...
		@Override
		public ResponsePublisher<Void> build() {
			return body(Mono.empty());
		}

		@Override
		public <T> ResponsePublisher<T> body(Publisher<T> body) {
			return new ResponsePublisher<T>(body, this.headers, this.statusCode);
		}
	}
