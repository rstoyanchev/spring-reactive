 ...
 * @see #getStatusCode()
 */
public class ResponseEntity2<T> extends HttpEntity<T> {
	 ...
	 * @param status the status code
	 */
	public ResponseEntity2(T body, HttpStatus status) {
	 ...
	 * @param status the status code
	 */
	public ResponseEntity2(MultiValueMap<String, String> headers, HttpStatus status) {
	 ...
	 * @param status the status code
	 */
	public ResponseEntity2(T body, MultiValueMap<String, String> headers, HttpStatus status) {
		super(body, headers);
	 ...
	 */
	private ResponseEntity2(T body, MultiValueMap<String, String> headers, Object statusCode) {
		super(body, headers);
	...
	/**
	 * Transform the ResponseEntity.
	 * @param transformer the transforming function
	 * @param <R> the target type
	 * @return the result of the transformation
	 */
	public <R> R as(Function<ResponseEntity2<T>, R> transformer) {
	...
	public boolean equals(Object other) {
		...
		ResponseEntity2<?> otherEntity = (ResponseEntity2<?>) other;
	 ...
	 * @since 4.1
	 */
	public static <T> ResponseEntity2<T> ok(T body) {
	...
	public interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
		 ...
		 */
		<T> ResponseEntity2<T> body(T body);
	}
	...
	private static class DefaultBuilder implements BodyBuilder {
		...
		@Override
		public ResponseEntity2<Void> build() {
			return body(null);
		}

		@Override
		public <T> ResponseEntity2<T> body(T body) {
			return new ResponseEntity2<>(body, this.headers, this.statusCode);
		}
	}
